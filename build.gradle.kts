...
allprojects {
    ...
    dependencies {
        ...
        "testImplementation"(group = "com.bakdata.fluent-kafka-streams-tests", name = "fluent-kafka-streams-tests-junit5", version = "2.1.0-SNAPSHOT")
        "testImplementation"(group = "org.apache.kafka", name = "kafka-streams-test-utils", version = kafkaVersion)
        "testImplementation"(group = "com.bakdata.fluent-kafka-streams-tests", name = "schema-registry-mock-junit5", version = "2.1.0-SNAPSHOT") {
            exclude(group = "junit")
        }
