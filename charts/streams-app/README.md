...
| Parameter     | Description                                       | Default |
|---------------|---------------------------------------------------|---------|
| `jmx.enabled` | Whether or not to expose JMX port.                | `false` |
...
| Parameter                    | Description                                                                                         | Default           |
|------------------------------|-----------------------------------------------------------------------------------------------------|-------------------|
| `prometheus.jmx.enabled`     | Whether or not to run Prometheus JMX Exporter as a java agent and expose JMX metrics to Prometheus. | `false`           |
| `prometheus.jmx.version`     | Version for Prometheus JMX Exporter agent.                                                          | `1.1.0`           |
