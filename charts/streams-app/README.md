...
| `streams.extraInputTopics`   | Map of additional named input topics.                                                                                                                                            | `{}`    |
| `streams.inputPattern`       | Input pattern of topics for your streams application.                                                                                                                            |         |
| `streams.extraInputPatterns` | Map of additional named input patterns.                                                                                                                                          | `{}`    |
| `streams.outputTopic`        | Output topic for your streams application.                                                                                                                                       |         |
| `streams.extraOutputTopics`  | Map of additional named output topics.                                                                                                                                           | `{}`    |
...
| `autoscaling.minReplicas`       | https://keda.sh/docs/2.7/concepts/scaling-deployments/#minreplicacount                                   | `0`        |
| `autoscaling.maxReplicas`       | https://keda.sh/docs/2.7/concepts/scaling-deployments/#maxreplicacount                                   | `1`        |
| `autoscaling.idleReplicas`      | https://keda.sh/docs/2.7/concepts/scaling-deployments/#idlereplicacount                                  |            |
