...
| `streams.namedInputTopics`   | Map of additional named input topics if you need to specify multiple topics with different message types.                                                                        | `{}`    |
| `streams.inputPattern`       | Input pattern of topics for your streams application.                                                                                                                            |         |
| `streams.namedInputPatterns` | Map of additional named input patterns if you need to specify multiple topics with different message types.                                                                      | `{}`    |
