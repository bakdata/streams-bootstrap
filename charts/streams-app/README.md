...
| `streams.optimizeLeaveGroupBehavior` | Enabling this optimizes the leave group behavior when a pod is terminated. Requires our app to use streams-bootstrap 2.7+.                                                       | `true`  |
