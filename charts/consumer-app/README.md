...
This chart can be used to deploy a Kafka Consumer app developed using streams-bootstrap.
...
| `replicaCount`                  | The number of Kafka Consumer replicas.                                                                                                                                                                                                                     | `1`                                        |
...
| `statefulSet`                   | Whether to use a [Statefulset](https://kubernetes.io/docs/concepts/workloads/controllers/statefulset/) instead of a [Deployment](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/) to deploy the consumer app.                        | `false`                                    |
...
| `livenessProbe`                 | Probe v1 definition for consumer-app: https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#probe-v1-core                                                                                                                                   | `{}`                                       |
| `readinessProbe`                | Probe v1 definition for consumer-app: https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#probe-v1-core                                                                                                                                   | `{}`                                       |
...
| Parameter          | Description                                 | Default       |
| ------------------ |---------------------------------------------|---------------|
| `image`            | Docker image of the Kafka Consumer app.     | `consumerApp` |
| `imageTag`         | Docker image tag of the Kafka Consumer app. | `latest`      |
...
| `kafka.stateDir`             | Directory for app state. Only configured when `persistence.enabled` and `statefulSet` are set to `true`.                                                                         | `/state/kafka-consumer` |
...
| `javaOptions.others`           | List of Java VM options passed to the consumer app.                                                                                          | `[]`    |

### Service

| Parameter         | Description                                                                                                                                                   | Default     |
|-------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| `service.enabled` | Whether to create a service. This requires the definition of at least one `ports.servicePort`. This also configures `application.server` for the consumer app | `false`     |
