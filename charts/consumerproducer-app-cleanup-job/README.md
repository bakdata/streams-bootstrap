# consumerproducer-app cleanup helm chart

This chart can be used to deploy a cleanup job for your Kafka ConsumerProducer app developed using streams-bootstrap.
Make sure to destroy the corresponding consumerproducer deployment before running the cleanup job.
...
the [consumerproducer app](https://github.com/bakdata/streams-bootstrap/tree/master/charts/consumerproducer-app) are available as well.
