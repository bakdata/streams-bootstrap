...
| `replicaCount`                  | The number of Kafka ConsumerProducer replicas.                                                                                                                                                                                                             | `1`                                        |
...
| `statefulSet`                   | Whether to use a [Statefulset](https://kubernetes.io/docs/concepts/workloads/controllers/statefulset/) instead of a [Deployment](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/) to deploy the consumerproducer app.                | `false`                                    |
...
| `livenessProbe`                 | Probe v1 definition for consumerproducer-app: https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#probe-v1-core                                                                                                                           | `{}`                                       |
| `readinessProbe`                | Probe v1 definition for consumerproducer-app: https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#probe-v1-core                                                                                                                           | `{}`                                       |
...
| Parameter                               | Description                                                                                                                                | Default |
|-----------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|---------|
| `persistence.enabled`                   | Use a [persistent volume](https://kubernetes.io/docs/concepts/storage/persistent-volumes/) to store the state of the consumerproducer app. | `false` |
...
| Parameter          | Description                                         | Default               |
| ------------------ |-----------------------------------------------------|-----------------------|
| `image`            | Docker image of the Kafka ConsumerProducer app.     | `consumerproducerApp` |
| `imageTag`         | Docker image tag of the Kafka ConsumerProducer app. | `latest`              |
...
| `kafka.stateDir`             | Directory for app state. Only configured when `persistence.enabled` and `statefulSet` are set to `true`.                                                                         | `/state/kafka-consumer-producer` |
...
| `javaOptions.others`           | List of Java VM options passed to the consumerproducer app.                                                                                  | `[]`    |

### Service

| Parameter         | Description                                                                                                                                                           | Default     |
|-------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| `service.enabled` | Whether to create a service. This requires the definition of at least one `ports.servicePort`. This also configures `application.server` for the consumerproducer app | `false`     |
